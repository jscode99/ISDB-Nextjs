        ...
        >
            <Row gutter={[16, 16]}>
                ...
                <Col span={12}>
                    <DropdownElement
                        label={`Sub Category`}
                        mandatory={typeof selectedCategory === "string" ? selectedCategory.toLowerCase() === "others" ? false : true : true}
                        placeholder={`Select`}
                        options={subitems}
                        onChange={handleSubCategory}
                        name="subcategory"
                        disabled={typeof selectedCategory === "string" ? selectedCategory.toLowerCase() === "others" ? true : loading : loading}
